...
public class UserIdent {
	...
	/**
	 * Create a UserIdent from a legacy string. The string can either be a UUID or a
	 * player name. Use this when reading legacy data or user configured values.
	 */
	...
	/**
	 * Create a UserIdent from a GameProfile. Use this when creating a UserIdent for
	...
	/**
	 * Please note that a UserIdent will successfully equal against GameProfiles and
	 * UUIDs.
	 */
	@Override
	...
	public void saveToNbt(@Nonnull CompoundTag nbt, @Nonnull String prefix) {
		if (uuid != null) {
			nbt.putString(prefix + ".uuid", String.valueOf(uuid));
		}
