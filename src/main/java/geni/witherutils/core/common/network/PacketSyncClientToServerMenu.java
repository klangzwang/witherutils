...
public class PacketSyncClientToServerMenu extends PacketClientToServerMenu<SyncedMenu> {

    private final CompoundTag data;

    public PacketSyncClientToServerMenu(int containerID, ListTag list)
    {
    ...
    public PacketSyncClientToServerMenu(FriendlyByteBuf buf)
    {
