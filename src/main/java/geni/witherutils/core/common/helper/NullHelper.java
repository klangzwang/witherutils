...
public final class NullHelper {
    ...
    @Nonnull
    public static <P> P notnull(@Nullable P o, @Nonnull String message) {
        return notnull(o, (Object) message);
    }

    @Nonnull
    public static <P> P notnullJ(@Nullable P o, @Nonnull String message) {
        return notnullJ(o, (Object) message);
    }

    @Nonnull
    public static <P> P notnullM(@Nullable P o, @Nonnull String message) {
        return notnullM(o, (Object) message);
    }

    @Nonnull
    public static <P> P notnullF(@Nullable P o, @Nonnull String message) {
    ...
    @Nonnull
    public static <P> P notnull(@Nullable P o, @Nonnull Object... message) {
        if (o == null) {
    ...
    @Nonnull
    public static <P> P notnullJ(@Nullable P o, @Nonnull Object... message) {
        if (o == null) {
    ...
    @Nonnull
    public static <P> P notnullM(@Nullable P o, @Nonnull Object... message) {
        if (o == null) {
    ...
    @Nonnull
    public static <P> P notnullF(@Nullable P o, @Nonnull Object... message) {
        if (o == null) {
    ...
    @Nonnull
    public static <P> P untrusted(@Nonnull P o, @Nonnull Object... message) {
        if (o == null) {
            throw new NullPointerException("There was a problem with Minecraft: The call '" + join(message)
    ...
    public static @Nullable <P> P untrust(@Nonnull P o) {
        return o;
    }

    @SafeVarargs
    public static @Nonnull <P> P first(@Nullable P... o) {
    ...
    @SafeVarargs
    public static @Nonnull <P> P first(@Nonnull Supplier<P>... o) {
    ...
    @SafeVarargs
    public static @Nullable <P> P firstOrNull(@Nonnull Supplier<P>... o) {
        for (Supplier<P> on : notnull(o, (Object) "... param is null")) {
            P p = notnull(on, (Object) "... param value is null").get();
            if (p != null) {
                return p;
    ...
    @SafeVarargs
    public static @Nonnull <P> P first(@Nullable P value, @Nonnull Supplier<P>... o) {
        if (value != null) {
            return value;
        }
        for (Supplier<P> on : notnull(o, (Object) "... param is null")) {
    ...
    public static @Nullable <P> P firstWithDefault(@Nullable P value, @Nonnull Supplier<P> on, @Nullable P d) {
        if (value != null) {
            return value;
        }
        P p = notnull(on, (Object) "... param value is null").get();
    ...
    @SafeVarargs
    public static @Nullable <P> P firstWithDefault(@Nullable P d, @Nonnull Supplier<P>... o) {
        for (Supplier<P> on : notnull(o, (Object) "... param is null")) {
            P p = notnull(on, (Object) "... param value is null").get();
            if (p != null) {
                return p;
