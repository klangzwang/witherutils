...
public class WitherFluidHandlerCapability implements IFluidHandlerItem, ICapabilityProvider {
	...
	public WitherFluidHandlerCapability(ItemStack container, int capacity) {
