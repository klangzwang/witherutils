...
public class SmartTVScreen extends WUTScreen<SmartTVContainer> {
	...
	protected void renderTVBG(GuiGraphics gg, float partialTicks, int mouseX, int mouseY)
	{
		...
		if(hasLogoPlayed)
		{
			...
			gg.blit(new ResourceLocation(WitherUtils.MODID, "textures/gui/smarttv.png"), relX, relY, 0, 0, this.imageWidth, this.imageHeight);
			ms.popPose();
			
			ms.pushPose();
			RenderSystem.setShader(GameRenderer::getPositionTexShader);
			RenderSystem.setShaderColor(bgr, bgg, bgb, 1.0f);
			gg.blit(new ResourceLocation(WitherUtils.MODID, "textures/gui/smarttv_bg.png"), relX, relY, 0, 0, this.imageWidth, this.imageHeight);
			RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
			ms.popPose();
			
			ms.pushPose();
			RenderSystem.setShader(GameRenderer::getPositionTexShader);
			gg.blit(new ResourceLocation(WitherUtils.MODID, "textures/gui/smarttv_home.png"), relX, relY, 0, 0, this.imageWidth, this.imageHeight);
			ms.popPose();
		}
		else
		{
			...
			gg.blit(new ResourceLocation(WitherUtils.MODID, "textures/gui/smarttv_logo.png"), relX, relY, 0, 0, this.imageWidth, this.imageHeight);
			RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
			ms.popPose();
		}
	}
