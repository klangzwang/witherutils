...
public class TotemRenderer extends AbstractBlockEntityRenderer<TotemBlockEntity> {
    ...
    public static final ResourceLocation EMISSIVEOFF = WitherUtilsRegistry.loc("textures/block/emissive/red.png");
    public static final ResourceLocation EMISSIVEON = WitherUtilsRegistry.loc("textures/block/emissive/green.png");
