...
public class LavaGeneratorScreen extends WUTScreen<LavaGeneratorContainer> {
    ...
    public LavaGeneratorScreen(LavaGeneratorContainer pMenu, Inventory pPlayerInventory, Component pTitle)
    {
    ...
    public void render(GuiGraphics gg, int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawTextWithScale(gg, Component.literal("Celsius: ").append(Component.literal(ChatFormatting.WHITE + "                °C")), leftPos + 47, topPos + 66, 0xFF00FF00, 0.5f, false);
        drawTextWithScale(gg, Component.literal(ChatFormatting.WHITE + "" + (double) menu.getBlockEntity().getTemperature()), leftPos + 78, topPos + 66, 0xFF00FF00, 0.75f, false);

        renderLavaChannel(gg, mouseY, mouseY, partialTicks);
    ...
    public void renderLavaChannel(GuiGraphics gg, int mouseX, int mouseY, float partialTicks)
    {   
    ...
    public void renderAnimated(GuiGraphics gg, int mouseX, int mouseY, float partialTicks, int timer)
    {
        if(timer == 0)
            return;
        gg.pose().pushPose();
        gg.blit(WitherUtils.loc("textures/block/blitz.png"), leftPos + 140, topPos + 44, 0, timer * 64, 32, 32, 32, 480);
        gg.pose().popPose();
    }
