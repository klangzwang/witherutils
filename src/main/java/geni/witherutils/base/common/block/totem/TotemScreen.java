...
public class TotemScreen extends WUTScreen<TotemContainer> {
    
    public TotemScreen(TotemContainer pMenu, Inventory pPlayerInventory, Component pTitle)
    {
	...
	public ResourceLocation getRenderTexture()
	{
		if(menu.getBlockEntity().getPreview())
			return WitherUtilsRegistry.loc("textures/gui/render_on.png");
		else
			return WitherUtilsRegistry.loc("textures/gui/render_off.png");
	}
    ...
    {
        return WitherUtilsRegistry.loc("textures/gui/totem.png");
    }
