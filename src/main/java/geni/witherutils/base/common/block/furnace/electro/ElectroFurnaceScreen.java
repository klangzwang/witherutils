...
public class ElectroFurnaceScreen extends WUTScreen<ElectroFurnaceContainer> {
    ...
    public ElectroFurnaceScreen(ElectroFurnaceContainer pMenu, Inventory pPlayerInventory, Component pTitle)
    {
    ...
    public void render(GuiGraphics gg, int mouseX, int mouseY, float partialTicks)
    {
        ...
        renderFadeProgress(gg, partialTicks, menu.getSlot(2).x + 8, 55, mouseX, mouseY, getMenu().getBlockEntity().getTimer() > 0, WitherUtils.loc("textures/gui/smeltprogress.png"));
    }
