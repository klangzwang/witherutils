...
import geni.witherutils.core.client.gui.widgets.io.IOConfigButton;
...
public class WaterGeneratorScreen extends WUTScreen<WaterGeneratorContainer> {
    ...
    protected void init()
    {
        ...
        addRenderableWidget(new IOConfigButton<>(this, leftPos + imageWidth - 6 - 16, topPos + 2, 16, 16, menu, this::addRenderableWidget, font));
    }
