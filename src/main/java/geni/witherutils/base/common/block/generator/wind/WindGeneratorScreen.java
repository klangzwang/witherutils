...
public class WindGeneratorScreen extends WUTScreen<WindGeneratorContainer> {

    private int timer;
    
    public WindGeneratorScreen(WindGeneratorContainer pMenu, Inventory pPlayerInventory, Component pTitle)
    {
