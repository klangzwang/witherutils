...
public class FeatherFallEnchantment extends EnchantmentWither
{
    public static final String ID = "feather_fall";
	
    public FeatherFallEnchantment(Rarity rarityIn, EnchantmentCategory typeIn, EquipmentSlot... slots)
    {
