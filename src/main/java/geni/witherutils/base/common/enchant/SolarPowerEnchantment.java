...
public class SolarPowerEnchantment extends EnchantmentWither
{
    public static final String ID = "solar_power";
	
    public SolarPowerEnchantment(Rarity rarityIn, EnchantmentCategory typeIn, EquipmentSlot... slots)
    {
