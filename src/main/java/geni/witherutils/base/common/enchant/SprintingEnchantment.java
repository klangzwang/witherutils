...
public class SprintingEnchantment extends EnchantmentWither
{
    public static final String ID = "sprinting";
	
    public SprintingEnchantment(Rarity rarityIn, EnchantmentCategory typeIn, EquipmentSlot... slots)
    {
