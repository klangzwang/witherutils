...
public class JumpingEnchantment extends EnchantmentWither
{
    public static final String ID = "jumping";
	
    public JumpingEnchantment(Rarity rarityIn, EnchantmentCategory typeIn, EquipmentSlot... slots)
    {
