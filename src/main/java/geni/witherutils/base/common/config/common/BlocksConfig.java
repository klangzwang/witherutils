...
public class BlocksConfig {
    ...
    public static ModConfigSpec.ConfigValue<Integer> ALLOYMAXENERGY;
    public static ModConfigSpec.ConfigValue<Integer> ALLOYSENDPERTICK;
    public static ModConfigSpec.ConfigValue<Integer> ALLOYUSEENERGY;
    
    public static ModConfigSpec.ConfigValue<Integer> FURNACEMAXENERGY;
    public static ModConfigSpec.ConfigValue<Integer> FURNACESENDPERTICK;
    public static ModConfigSpec.ConfigValue<Integer> FURNACEUSEENERGY;
    
    public static ModConfigSpec.ConfigValue<Integer> MINERMAXENERGY;
    public static ModConfigSpec.ConfigValue<Integer> MINERSENDPERTICK;
    public static ModConfigSpec.ConfigValue<Integer> MINERUSEENERGY;
    
    public static ModConfigSpec.ConfigValue<Integer> TANKDRUMCAPACITY;
    
    public static ModConfigSpec.ConfigValue<Integer> GREENHOUSECHANCE;
    public static ModConfigSpec.ConfigValue<Boolean> GREENHOUSEMOISTURE;
    
    public static ModConfigSpec.ConfigValue<Integer> COLLECTORRANGE;
    public static ModConfigSpec.ConfigValue<Integer> COLLECTORMAXITEMS;
    
	public static ModConfigSpec.ConfigValue<Integer> FISHINGTIMER;
	public static ModConfigSpec.ConfigValue<Integer> FISHINGCOOLDOWN;
	public static ModConfigSpec.ConfigValue<Integer> FISHINGMAXFOOD;
	
    public static ModConfigSpec.ConfigValue<Integer> ITEMCONTROLLERCAPACITY;
    public static ModConfigSpec.ConfigValue<Integer> FLUIDCONTROLLERCAPACITY;
    
    public static ModConfigSpec.ConfigValue<Double> MACHINESOUND_VOLUME;
