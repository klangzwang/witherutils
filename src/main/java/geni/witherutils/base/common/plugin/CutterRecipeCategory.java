...
public class CutterRecipeCategory extends MachineCategory<CutterRecipe> implements IRecipeCategory<CutterRecipe> {
	...
	private static final ResourceLocation ID = new ResourceLocation(WitherUtils.MODID, "cutter");
	...
	{
		super(helper, false);
		gui = helper.drawableBuilder(new ResourceLocation(WitherUtils.MODID, "textures/jei/cutter_recipe.png"), 0, 0, 169, 69).setTextureSize(169, 69).build();
	...
	public void draw(CutterRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics gg, double mouseX, double mouseY)
	{
	    ...
	    gg.drawString(font, "" + recipe.getIngredient(), 42, 50, FONT, false);
...
//	    animatedFlame.draw(gg, 51, 29);
	...
	{
		builder.addSlot(INPUT, 13, 26).addIngredients(recipe.at(0));
