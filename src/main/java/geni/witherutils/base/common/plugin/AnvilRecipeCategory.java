...
public class AnvilRecipeCategory implements IRecipeCategory<AnvilRecipe> {
	...
	{
		gui = helper.drawableBuilder(new ResourceLocation(WitherUtils.MODID, "textures/jei/anvil_recipe.png"), 0, 0, 169, 69).setTextureSize(169, 69).build();
	...
	public void draw(AnvilRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics gg, double mouseX, double mouseY)
	{
	    ...
	    gg.drawString(font, recipe.getHitCounter() + " Hits needed", 90, 30, FONT, false);
