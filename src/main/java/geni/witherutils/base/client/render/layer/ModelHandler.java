...
@EventBusSubscriber(modid = WitherUtils.MODID, bus = Bus.MOD, value = Dist.CLIENT)
@OnlyIn(Dist.CLIENT)
public class ModelHandler {
	...
	{
		ModelLayerLocation loc = new ModelLayerLocation(new ResourceLocation(WitherUtils.MODID, name), "main");
	...
	public static void registerLayer(EntityRenderersEvent.RegisterLayerDefinitions event)
	{
		...
		{
			WitherUtils.LOGGER.info("Registering model layer " + location);
